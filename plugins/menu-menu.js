...
let str = `
*ミ💖 ПРИВЕТ✨${taguser}✨, ЗДЕСЬ ВСЕ КОМАНДЫ БОТА ЛЮЦИАНА 💖彡*
...
° ඬ⃟🎖️ _${usedPrefix}★Люциан - 𝙱𝚘𝚝★*<текст>*_
...
handler.command = /^(меню|menú|memu|memú|info|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i
handler.exp = 50
handler.fail = null
...
let str = `
*ミ💖 Здравствуйте ✨${name}✨, ЗДЕСЬ ВСЕ КОМАНДЫ БОТА LUCIAN 💖彡*
